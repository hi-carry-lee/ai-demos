...
async function JobInfos() {
  ...
  return (
    <section className="container my-4 mt-8">
      <header className="flex gap-2 justify-between items-center mb-10">
      ...
      <ul className="grid grid-cols-1 lg:grid-cols-2 gap-6 has-hover:*:not-hover:opacity-70">
        {jobInfos.map((jobInfo) => (
          ...
          >
            <Link href={`/app/job-infos/${jobInfo.id}`}>
        ...
        {/* 和上面的按钮Create Job Description相同，可以去掉 */}
